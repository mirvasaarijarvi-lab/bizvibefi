...
SET 
  title_fi = 'GoodVibesCafe MeetUp: Tule tutustumaan meihin!',
  description_fi = 'Tule mukaan rentoon GoodVibesCafe-tapaamiseen. Tapaat perustajajäsenet, kollektiivin, ja muita devaajia. Tule kuulemaan, mistä GoodVibesCafessa on kyse, miten eri tasot tarjoavat sinulle ja miten pääset mukaan.',
