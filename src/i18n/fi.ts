  ...
  admin: {
    showcase: {
      ...
      reject: {
        ...
        description: "Anna syy \"{title}\" hylkäämiselle. Tämä näkyy lähettäjälle.",
        reasonLabel: "Syy",
        reasonPlaceholder: "Selitä miksi tämä lähetys hylättiin…",
        cancel: "Peruuta",
        confirm: "Hylkää",
        reasonRequired: "Hylkäyksen syy vaaditaan",
        success: "Kohde hylätty",
