const fi = {
  ...
  community: {
    ...
    free: {
      ...
      benefits: [
        ...
        { title: "Starter LinkedIn -merkki", desc: "Näytä maailmalle, että kuulut BizVibe-kollektiiviin." },
      ],
    },
    pro: {
      name: "Viber",
    ...
    vibetor: {
      ...
      cta: "Hae Vibetoriksi",
      benefits: [
        { title: "Suora yhteys perustajiin", desc: "Ohita jono. Tavoita BizVibe-perustajat suoraan." },
  ...
  badges: {
    pageTitle: "Merkit",
    pageDesc: "Ansaitse tunnustusta työstäsi BizVibe-kollektiivissa.",
    tag: "Tunnustus",
    title: "Ansaitse",
