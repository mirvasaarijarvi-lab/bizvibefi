const en = {
  ...
  community: {
    ...
    free: {
      ...
      benefits: [
        ...
        { title: "Starter LinkedIn Badge", desc: "Show the world you're part of the <Good Vibes Café/> collective." },
      ],
    },
    pro: {
      name: "Viber",
    ...
    vibetor: {
      ...
      cta: "Apply as Vibetor",
      benefits: [
        { title: "Direct Contact with Founders", desc: "Skip the queue. Reach <Good Vibes Café/> founders directly." },
  ...
  about: {
    ...
    desc: "We started <Good Vibes Café/> because we were tired of building alone. The best things happen when you combine complementary chaos, so we built a collective around it.",
    foundersHeading: "<Good Vibes Café/>",
  ...
  footer: {
    ...
    company: "Company",
    connect: "Connect",
    rights: "<Good Vibes Café/> Collective. All rights reserved.",
  },
  showcase: {
    pageTitle: "Showcase",
    pageDesc: "Discover case studies, testimonials, and tools built by the <Good Vibes Café/> community.",
    tag: "Showcase",
    title: "Built by the",
    ...
    tabs: { all: "All", caseStudies: "Case Studies", testimonials: "Testimonials", tools: "Tools", guidebooks: "Guidebooks", sampleCode: "Codes & Prompts", infographics: "Infographics", toolsToTest: "Tools to Test" },
    by: "by",
    visitLink: "Visit",
    reviews: "Reviews",
  ...
  badges: {
    pageTitle: "Badges",
    pageDesc: "Earn recognition for the work you do with the <Good Vibes Café/> collective.",
    tag: "Recognition",
    title: "Earn your",
