  ...
  admin: {
    showcase: {
      ...
      reject: {
        ...
        description: "Please provide a reason for rejecting \"{title}\". This will be visible to the submitter.",
        reasonLabel: "Reason",
        reasonPlaceholder: "Explain why this submission was rejected…",
        cancel: "Cancel",
        confirm: "Reject",
        reasonRequired: "A rejection reason is required",
        success: "Item rejected",
        failed: "Failed to reject item",
      },
