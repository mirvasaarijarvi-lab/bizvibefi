...
const Contact = () => {
  ...
  return (
    <Layout>
      <PageMeta title="Contact — <Good Vibes Café/>" description="Got an idea, question, or just want to say hi? Reach out to the <Good Vibes Café/> collective." />
      <section className="py-24 md:py-32">
        <div className="container max-w-4xl">
          ...
          >
            <HeroAvatar src={mascotPeek} alt="<Good Vibes Café/> peeking mascot" />
