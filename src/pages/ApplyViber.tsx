...
const ApplyViber = () => {
  ...
  if (!user) {
    return (
      <Layout>
        <PageMeta title="Apply for Viber — BizVibe" description="Become a Viber member of BizVibe." />
  ...
  if (submitted) {
    return (
      <Layout>
        <PageMeta title="Application Submitted — BizVibe" description="Your Viber application has been submitted." />
        <section className="py-24 md:py-36">
          <div className="container max-w-lg text-center">
  ...
  return (
    <Layout>
      <PageMeta title="Become a Viber — BizVibe" description="Apply for Viber membership and get invoiced for €199/year (or €599/year for company partners)." />
