...
const AdminCertificates = () => {
  ...
  const handleIssue = async () => {
    ...
    try {
      const cert = await issueCert.mutateAsync({
        ...
        issued_by: user.id,
        issued_by_name: profile?.display_name ?? "<Good Vibes Café/> Founder",
      });
  ...
  return (
    <Layout>
      <PageMeta title="Issue Certificate — <Good Vibes Café/>" description="Founder tool for issuing course completion certificates." />
            ...
            <Card className="mt-6 border-primary/40">
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <AddToLinkedInButton
                    name={courseTitle || "<Good Vibes Café/> Course"}
