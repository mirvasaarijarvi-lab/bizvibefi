...
const CertificateVerify = () => {
  ...
  if (!cert) {
    return (
      <Layout>
        <PageMeta title="Certificate not found — BizVibe" description="This certificate could not be verified." />
  ...
  return (
    <Layout>
      <PageMeta
        title={`${cert.participant_name} — ${cert.course_title} | BizVibe`}
        description={`${cert.participant_name} completed ${cert.course_title} with BizVibe on ${formatDate(cert.completion_date)}.`}
      />
      <section className="py-24 md:py-32">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">BizVibe Founder</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
