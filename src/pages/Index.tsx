...
const Index = () => {
  ...
  return (
    <Layout>
      <PageMeta title="GoodVibesCafe — The Collective for Builders" description="A collective of builders, strategists and connectors. Shoot first, fail spectacularly, ship solid." />
      {/* Hero */}
