...
const TermsOfService = () => (
  <Layout>
    <PageMeta
      title="Terms of Service — BizVibe"
      description="BizVibe Terms of Service covering usage rules, intellectual property, liability, and membership terms."
    />
    <div className="container max-w-3xl py-16 space-y-10">
      ...
      <section className="space-y-4 font-body text-foreground/90 leading-relaxed">
        ...
        <p>
          By accessing or using the BizVibe platform ("Service"), you agree to be bound by these
      ...
      <section className="space-y-4 font-body text-foreground/90 leading-relaxed">
        ...
        <p>
          BizVibe is a community platform for builders, founders, and creators. The Service includes
      ...
      <section className="space-y-4 font-body text-foreground/90 leading-relaxed">
        ...
        <p>
          BizVibe offers Free and Pro membership tiers. Free tier access is provided at no cost. Pro
      ...
      <section className="space-y-4 font-body text-foreground/90 leading-relaxed">
        ...
        <p>
          ...
          Content, you grant BizVibe a non-exclusive, worldwide, royalty-free license to use,
      ...
      <section className="space-y-4 font-body text-foreground/90 leading-relaxed">
        ...
        <p>
          ...
          are owned by BizVibe Collective and are protected by international copyright, trademark,
      ...
      <section className="space-y-4 font-body text-foreground/90 leading-relaxed">
        ...
        <p>
          ...
          merchantability, fitness for a particular purpose, and non-infringement. BizVibe does not
      ...
      <section className="space-y-4 font-body text-foreground/90 leading-relaxed">
        ...
        <p>
          To the fullest extent permitted by applicable law, BizVibe Collective and its founders,
          ...
          you paid to BizVibe in the twelve (12) months preceding the claim.
        </p>
      </section>
      ...
      <section className="space-y-4 font-body text-foreground/90 leading-relaxed">
        ...
        <p>
          You agree to indemnify, defend, and hold harmless BizVibe Collective and its founders,
